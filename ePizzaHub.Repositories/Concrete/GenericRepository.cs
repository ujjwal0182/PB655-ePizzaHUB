...
namespace ePizzaHub.Repositories.Concrete
{
    ...
    {
        // Now this generic repo will interact the my DBContext (db my case its PB655Context)
        ...
        //{
        //    _dbcontext.Set<T>().Add(entity); //This means that i am free to pass any of the models. Lets say if i want to insert record into my User table,
